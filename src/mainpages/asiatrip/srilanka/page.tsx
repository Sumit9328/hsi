...
export default function SriLanka(): React.ReactElement {
  ...
  const destinations = [
    {
      ...
      image: "/images/Banner-images/srilanka.jpg",
      rating: 5,
      days: "3 days",
      price: "$559",
      emiOptions: ["3 months – $190/month", "6 months – $100/month"]
    },
    {
      id: "kandy",
          ...
          <div className="breadcrumb-content">
            ...
            <nav aria-label="breadcrumb">
              <ul className="breadcrumb">
                ...
                <li className="breadcrumb-item active" aria-current="page">Sri Lanka</li>
              </ul>
            </nav>
          </div>
        </div>
